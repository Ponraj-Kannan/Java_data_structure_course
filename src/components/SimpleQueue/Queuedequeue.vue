...
const CODES = {
  java: [
    ...
    ['c_rearnull', '        if (front == null) {'],
    ['c_rearnull', '            rear = null;'],
    ['c_rearnull', '        }'],
    ['c_size', '        size--;'],
  ...
  python: [
    ...
    ['c_rearnull', '        if self.front is None:'],
    ['c_rearnull', '            self.rear = None'],
    ['c_size', '        self.size -= 1'],
    ['c_return', '        return data'],
  ],
  javascript: [
    ...
    ['c_rearnull', '    if (this.front === null) {'],
    ['c_rearnull', '      this.rear = null;'],
    ['c_rearnull', '    }'],
    ['c_size', '    this.size--;'],
    ['c_return', '    return data;'],
    ['', '  }'], ['', '}'],
...
function buildSteps(values) {
  ...
  while (nodes.length > 0) {
    ...
    const newFrontAddr = nodes.length > 1 ? nodes[1].addr : null;
    steps.push({
    ...
    if (nodes.length === 0) {
      ...
      steps.push({
        nodes: [...nodes], frontAddr, rearAddr, size,
        badge: 'front == null \u2192 queue now empty, rear = null too', code: 'c_rearnull',
    ...
    steps.push({
      nodes: [...nodes], frontAddr, rearAddr, size,
      badge: 'size-- \u2192 size = ' + size + ', dequeue() returns ' + removedVal, code: 'c_return',
      ...
      <div class="ll-right-col">
        <div class="ll-code-panel">
          ...
          <div v-else class="ll-info-scroll">
            <h3>Algorithm — Dequeue</h3>
            <p>
              Dequeue removes the node at the <code>front</code> of the queue. The <code>front</code> pointer
              simply advances to <code>front.next</code>; no traversal is ever needed. If the removed node was
              the only node in the queue, <code>rear</code> must also be reset to <code>null</code>.
            </p>
            ...
            <table class="ll-complexity-table">
              ...
              <tbody>
                <tr><td>Best / Average / Worst</td><td>O(1)</td><td>the <code>front</code> pointer gives direct access to the node to remove</td></tr>
            ...
            <ol>
              ...
              <li>When the last remaining node is dequeued, both <code>front</code> and <code>rear</code> become <code>null</code> — the queue must not leave a dangling <code>rear</code>.</li>
            ...
            <ol>
              ...
              <li><b>Single node:</b> removing the only node sets both <code>front</code> and <code>rear</code> to <code>null</code>.</li>
              <li><b>Multiple dequeues:</b> repeatedly removing from the front until the queue is empty, then underflowing on the next call.</li>
            </ol>
            <p class="ll-note">
              Note: unlike an array-based queue, a linked-list queue never needs to shift elements after removal —
              advancing the <code>front</code> pointer is enough, which is exactly what keeps Dequeue at O(1).
            </p>
          </div>
        </div>
      </div>
